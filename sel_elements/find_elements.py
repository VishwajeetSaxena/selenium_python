...
class Find_By_Name():
    ...
    def test(self):
        ...
        element_id = driver.find_elements(By.ID, 'name')
        if element_id != None:
        ...
        element_name = driver.find_elements(By.NAME, 'show-hide')
        ...
        element_xpath = driver.find_elements(By.XPATH, './/*[@id="name"]')
        ...
        element_css = driver.find_elements(By.CSS_SELECTOR, '#displayed-text')
        ...
        element_linkText = driver.find_elements(By.LINK_TEXT, 'Login')
        ...
        element_partialLinkText = driver.find_elements(By.PARTIAL_LINK_TEXT, 'Pract')
        ...
        element_classname = driver.find_elements(By.CLASS_NAME, 'input')
        ...
        element_tag = driver.find_elements(By.TAG_NAME, 'a')
